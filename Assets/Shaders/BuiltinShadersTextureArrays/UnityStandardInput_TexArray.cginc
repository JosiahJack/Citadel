...
#ifdef _SPECGLOSSMAP
    #if defined(_SMOOTHNESS_TEXTURE_ALBEDO_CHANNEL_A)
        sg.rgb = UNITY_SAMPLE_TEX2DARRAY(_SpecGlossMap, uv).rgb;
        sg.a = UNITY_SAMPLE_TEX2DARRAY(_MainTex, uv).a;
    #else
        sg = UNITY_SAMPLE_TEX2DARRAY(_SpecGlossMap, uv);
    #endif
    sg.a *= _GlossMapScale;
#else
...
//#ifdef _SPECGLOSSMAP
//    mg.g = 1.0f - UNITY_SAMPLE_TEX2DARRAY(_SpecGlossMap, uv).r;
//#else
//    mg.g = 1.0f - _Glossiness[uv.z];
//#endif
//    return mg;
//}
