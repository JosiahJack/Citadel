...
public class QuestBitRelay : MonoBehaviour {
	...
	public void TestBits(bool testIfTrue, UseData ud, TargetIO tio) {
		if (RobotSpawnDeactivated && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.RobotSpawnDeactivated, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (IsotopeInstalled && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.IsotopeInstalled, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (ShieldActivated && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.ShieldActivated, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (LaserSafetyOverriden && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.LaserSafetyOverriden, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (LaserDestroyed && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.LaserDestroyed, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (BetaGroveCyberUnlocked && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.BetaGroveCyberUnlocked, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (GroveAlphaJettisonEnabled && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.GroveAlphaJettisonEnabled, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (GroveBetaJettisonEnabled && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.GroveBetaJettisonEnabled, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (GroveDeltaJettisonEnabled && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.GroveDeltaJettisonEnabled, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (MasterJettisonBroken && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.MasterJettisonBroken, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (Relay428Fixed && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.Relay428Fixed, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (BetaGroveJettisoned && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.BetaGroveJettisoned, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (AntennaNorthDestroyed && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.AntennaNorthDestroyed, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (AntennaSouthDestroyed && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.AntennaSouthDestroyed, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (AntennaEastDestroyed && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.AntennaEastDestroyed, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (AntennaWestDestroyed && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.AntennaWestDestroyed, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (SelfDestructActivated && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.SelfDestructActivated, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (BridgeSeparated && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.BridgeSeparated, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
		if (IsolinearChipsetInstalled && (target != "" || targetIfFalse != "")) Const.a.questData.TargetOnGatePassed(Const.a.questData.IsolinearChipsetInstalled, testIfTrue, ud, tio, target, argvalue, targetIfFalse, argvalueIfFalse);
	}
}
