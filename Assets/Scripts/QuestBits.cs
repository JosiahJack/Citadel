...
public class QuestBits {
	...
	public string Save() {
		...
		s1.Clear();
		s1.Append(lev1SecCode.ToString());
		s1.Append(Utils.splitChar);
		s1.Append(lev2SecCode.ToString());
		s1.Append(Utils.splitChar);
		s1.Append(lev3SecCode.ToString());
		s1.Append(Utils.splitChar);
		s1.Append(lev4SecCode.ToString());
		s1.Append(Utils.splitChar);
		s1.Append(lev5SecCode.ToString());
		s1.Append(Utils.splitChar);
		s1.Append(lev6SecCode.ToString());
		s1.Append(Utils.splitChar);
		s1.Append(Utils.BoolToString(RobotSpawnDeactivated));
		s1.Append(Utils.splitChar);
		s1.Append(Utils.BoolToString(IsotopeInstalled));
		s1.Append(Utils.splitChar);
		s1.Append(Utils.BoolToString(ShieldActivated));
		s1.Append(Utils.splitChar);
		s1.Append(Utils.BoolToString(LaserSafetyOverriden));
		s1.Append(Utils.splitChar);
		s1.Append(Utils.BoolToString(LaserDestroyed));
		s1.Append(Utils.splitChar);
		...
		s1.Append(Utils.splitChar);
		s1.Append(Utils.BoolToString(Relay428Fixed));
		s1.Append(Utils.splitChar);
		...
		s1.Append(Utils.splitChar);
		s1.Append(Utils.BoolToString(BridgeSeparated));
		s1.Append(Utils.splitChar);
